<?php  //[STAMP] 51effd3ee26b9b6e76c3452370062eaf
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Codeception\Module\ApiHelper::carbonize()
     */
    public function carbonize($date) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('carbonize', func_get_args()));
    }
